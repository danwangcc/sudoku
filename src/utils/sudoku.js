...
sudoku.$generate = (difficulty, unique) => {
    const initBoard = sudoku.generate(difficulty, unique)
    const answer = sudoku.solve(initBoard)

    return [stringToArray(initBoard), stringToArray(answer)]
}
